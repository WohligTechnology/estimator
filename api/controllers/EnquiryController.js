...
var controller = {
    ...
    getEstimateVersionData: function (req, res) {
        if (req.body) {
            Enquiry.getEstimateVersionData(req.body, res.callback);
        } else {
            res.json({
                value: false,
                data: {
    ...
    deleteMultipleEnquiry: function (req, res) {
        if (req.body) {
            Enquiry.deleteMultipleEnquiry(req.body, res.callback);
        } else {
            res.json({
                value: false,
                data: {
    ...
    testingAsync: function (req, res) {
        if (req.body) {
            Enquiry.testingAsync(req.body, res.callback);
        } else {
            res.json({
                value: false,
                data: {

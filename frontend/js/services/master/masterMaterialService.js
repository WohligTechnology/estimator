myApp.service('masterMaterialService', function (NavigationService) {
    ...
    this.deleteMaterialCat = function (materialCatId, callback) {
        ...
        NavigationService.apiCall('MMaterialCat/delRestrictionMaterialCat', {_id: materialCatId}, function (data) {
            callback(data);
        });
    }
    ...
    this.deleteMaterialSubCat = function (materialSubCatId, callback) {
        ...
        NavigationService.apiCall('MMaterialSubCat/delRestrictionMMaterialSubCat', {_id: materialSubCatId}, function (data) {
            callback(data);
        });
    }
    ...
    this.deleteMaterial = function (materialId, callback) {
        ...
        NavigationService.apiCall('MMaterial/delRestrctionsOfMaterial', {idsArray: idsArray}, function (data) {
            callback(data);
        });
    }
